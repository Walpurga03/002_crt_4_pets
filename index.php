...
<head>
  ...
  <meta name="keywords" content="Theralogy, Körperzellen, Stärkung, Redater, Regeneration, Zelltraining" />
...
<body>
  <section class="booking-modal" id="booking-modal">
    <div class="booking-modal__content">
      ...
      <p class="booking-modal__paragraph">Ich melde mich schnellstmöglich bei Ihnen</p>

      <form class="form" action="form.php" method="POST">
        <div class="form__horizontal">
          <div class="form__group">
            <input name="name" type="text" class="form__input" id="booking-modal-name" placeholder="Name" />
            <label class="form__label" for="booking-modal-name">Name</label>
          </div>
          <div class="form__group">
            <input name="email" type="text" class="form__input" id="booking-modal-email" placeholder="E-Mail" />
            <label class="form__label" for="booking-modal-email">E-Mail</label>
          </div>
        </div>

        <label for="contact-message" class="contact-label"></label>
        <textarea name="nachricht" id="contact-message" class="no-outline" placeholder="Ihre Nachricht"
          required="required"></textarea>
        <div class="booking-modal__submit-container">
          <input type="submit" class="
          booking-modal__button
          booking-modal__button--form" value="Anfrage abschicken!" />
        </div>
      </form>
    </div>
  </section>
  <section>
    <div class="navbar">
      <div class="header__logo">
        <a href="#home"><img class="navigation__logo" src="./images/header/logoSchwartz.png" alt="logoSchwartz"></a>
      </div>
      <nav class="navigation stroke">
        <ul class="navigation__list">
          ...
          <li class="navigation__list-item navigation__list-item--mobile-hidden">
            <a class="navigation__list-item-link" href="#eindruecke">Crt-4-pets</a>
          </li>
          <li class="navigation__list-item navigation__list-item--mobile-hidden">
          ...
          <li class="navigation__list-item navigation__list-item--mobile-hidden">
            <a class="navigation__list-item-link" href="#ueberMich">Über mich</a>
          </li>
          <li class="navigation__list-item navigation__list-item--mobile-hidden">
            <a class="navigation__list-item-link" href="#kontakt">Kontakt</a>
          </li>

          <a href="#booking-modal"><button
              class="button button--slim button--secondary  button-anfrage">Anfrage</button>
          </a>
          <li class="navigation__list-item navigation__list-item--menu">
            <label class="navigation__list-item-link" for="sidenav__opened">
              <svg class="navigation__icon" viewBox="0 0 512 512">
                <g>
                  <path d="M358.06,193.61H153.94c-3.83,0-6.93-3.1-6.93-6.93s3.1-6.93,6.93-6.93h204.13c3.83,0,6.93,3.1,6.93,6.93
                                            S361.89,193.61,358.06,193.61z" />
                  <path d="M358.06,262.93H153.94c-3.83,0-6.93-3.1-6.93-6.93c0-3.83,3.1-6.93,6.93-6.93h204.13
                                            c3.83,0,6.93,3.1,6.93,6.93C365,259.83,361.89,262.93,358.06,262.93z" />
                  <path d="M358.06,332.25H153.94c-3.83,0-6.93-3.1-6.93-6.93c0-3.83,3.1-6.93,6.93-6.93h204.13
                                            c3.83,0,6.93,3.1,6.93,6.93C365,329.15,361.89,332.25,358.06,332.25z" />
                  <path d="M256,474.76c-120.62,0-218.76-98.14-218.76-218.76c0-120.63,98.14-218.76,218.76-218.76
  ...
  <header class="header" id="home">
    <div class="header__container">
      ...
      <div class="wrapper">
        <div class="one">
          <img class="header__crtStudio" src="./images/header/CRT-Praxis.png" alt="CRT-Praxis">
        </div>
        <div class="two">
          <img class="header__logoWinkt" src="./images/header/logoTiere_1.jpg" alt="logoTiere">
        </div>
        <div class="three">
          <p class="header__text-ort">Ihr Cell-Re-Active-Praxis-4-Pets</p>
        </div>
        <div class="four">
          <img class="header__vielFelltig" src="./images/header/vielFELLtig.png" alt="vielFellitig einsatzbar">
        </div>
      </div>
    </div>
    ...
    <div class="motivation__container">
      <div>
        <div class="motivation__column-text">
          ...
          <ol reversed>
            <li class="motivation__text-first">
              <p>durch Training die Zellleistung nachhaltig stabilisiert</p>
            </li>
            <li class="motivation__text-second">
              <p>durch Reflektion Zellen reaktivieren</p>
            </li>
            <li class="motivation__text-third">
              <p>inaktive Zellen aufspürt und deren Zellkommunikationskraft st&auml;rkt</p>
            </li>
          </ol>
          </br>
        ...
        <div class="motivation__column-images">
          <img class="motivation__image motivation__image--first" src="images/animal/kuh_1.png" alt="Kuh" />
          <img class="motivation__image motivation__image--second" src="images/animal/hund.png" alt="Hund" />
          <img class="motivation__image motivation__image--third" src="images/animal/katze.jpg" alt="Katze" />
        </div>
      </div>
    </div>
    <div>
      <img class="motivation__banner" src="images/animal/CRT-4-PETS.png" alt="Theralogy Konzept">
    </div>
  </section>
    ...
    <div class="gallery__container">
      <div class="gallery__list">
        <a class="gallery__list-item">
          <img class="gallery__list-item-image" src="./images/gallery/katze_1.png" alt="Katze" />
        </a>
        <a class="gallery__list-item">
          <img class="gallery__list-item-image" src="./images/gallery/hund_3.png" alt="Hund" />
        </a>
        <a class="gallery__list-item">
          <img class="gallery__list-item-image" src="./images/gallery/ente_1.png  " alt="Ente" />
        </a>
      </div>

      <input class="gallery__cb-toggle" id="gallery__cb-toggle" type="checkbox" autocomplete="off">
      ...
      <div class="gallery__list gallery__list--cb-toggle">
        <a class="gallery__list-item">
          <img class="gallery__list-item-image" src="./images/gallery/hund_2.png" alt="Hund" />
        </a>
        <a class="gallery__list-item">
          <img class="gallery__list-item-image" src="./images/gallery/kuh_1.png" alt="Kuh" />
        </a>
        <a class="gallery__list-item">
          <img class="gallery__list-item-image" src="./images/gallery/pferd_1.png" alt="Pferd" />
        </a>
      </div>
    </div>
    <div class="gallery__24h-7d">
      <p class="gallery__24h-7d-color">Das reaktive Gesundheitstraining <span>24</span><span>/</span><span>7</span>
      </p>
    </div>
  ...
  <section class="video" id="video">
    <div class="video__container">
      <video class="video__movie" src="./videos/videoTiere.mp4" controls poster="vorschaubild.jpg">
  ...
  <section class="about" id="ueberMich">
    ...
    <div class="about__container">
      <div class="about__slideshow">
        <img class="about__img" src="images/ueberMich/foto1.png" alt="Foto Birgit_1" />
        <img class="about__img about__img--slideshow about__img--slideshow-1" src="images/ueberMich/foto2.png"
          alt="Foto Birgit_2" />
        <img class="about__img about__img--slideshow about__img--slideshow-3" src="images/ueberMich/hundW_2.jpg"
          alt="Foto Birgit_3" />
      </div>
      <div class="about__text">
        <h3 class="about__heading">Über mich</h3>
        <p class="about__paragraph">Mein Name ist Birgit Spielberger, ich bin verheiratet und Mutter von 2 Kindern.
          <br />Ich lebe mit meiner Familie in Dornbirn.
          <br />Auf meinem bisherigen Weg durfte ich bereits viel Lernen was ich gerne auch heute in meiner
          eigenen Praxis einbringen und umsetzen darf.
          Mein Bestreben nach der Ursachenfindung brachte mich schlussendlich zu Theralogy.
          Ich durfte meine Ausbildung persönlich bei David Overbeck,<br /> dem Erfinder von
          Theralogy und dem Cell-Re-Active-Training absolvieren.
          Auch in der Zeit von und mit Corona ist es mir ein Anliegen,<br />
          den Menschen und Tieren mit Hilfe des Cell-Re-Active-Trainings
          eine Möglichkeit anzubieten,Ihre Zellen 24/7 zu trainieren.
          <br />
          <br />
          Hier finden Sie weitere Informationen über meine Praxis (
          <a class="about__link" href="https://spielberger.at" target="_blank">klicke hier</a>).
          <br />
        </p>
        <blockquote>
        ...
        <p class="about__paragraph">
          Wenn auch Sie mehr für das Wohlbefinden Ihres Tieres tun wollen
          und Sie denken, dass ich Ihnen dabei behilflich sein kann, können
          Sie sich gerne mit mir in Verbindung setzen.
        </p>
      </div>
    </div>
  </section>
  <section class="footer" id="kontakt">
      ...
      <div class="footer__text-column">
        ...
        <div class="footer__contact-item">
          <div class="footer__contact-item-icon">
            <svg class="footer__icon footer__icon--no-position" viewBox="0 0 512 512">
              <path d="M432.93,176.46L278.35,76.46c-13.6-8.8-31.11-8.8-44.71,0l-154.59,100c-11.72,7.58-18.8,20.6-18.8,34.56v185.41
          ...
          <a class="footer__contact-item-link" href="mailto:praxis@spielberger.at"
            target="_blank">praxis@spielberger.at</a>
        </div>
        <div class="footer__contact-item">
          <div class="footer__contact-item-icon footer__contact-item-icon--phone">
            <svg class="footer__icon" viewBox="0 0 512 512">
              <g>
                <path d="M412.93,331.8l-44.52-24c-10.84-5.84-19.27-1.62-28.6,11.23c-20.5,28.2-30.44,33.78-55.6,19.73
          ...
          <a class="footer__contact-item-link" href="tel:+436642146872" target="_blank">+43 664 214 68 72</a>
        </div>
      </div>
      <div class="footer__logo-column">
        <img class="footer__logo" src="./images/footer/spielberger-weiss-800.png" alt="logo_weiss">
      </div>
    </div>
    <footer class="footer__footer">
      <ul class="footer__footer-list">
        ...
        <li>
          <a class="footer__footer-link" href="dse.html">Datenschutzerklärung</a>
        </li>
        <li>
    ...
    <div class="sidenav__container">
      ...
      <nav>
        <ul class="sidenav__nav">
          ...
          <li><a href="#eindruecke" class="sidenav__nav-link">CRT-4_Pets</a></li>
          <li><a href="#gallery" class="sidenav__nav-link">Galerie</a></li>
          <li><a href="#video" class="sidenav__nav-link">Video</a></li>
          <li><a href="#ueberMich" class="sidenav__nav-link">Über mich</a></li>
